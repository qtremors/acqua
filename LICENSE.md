...
3. **Link Back**: Provide a direct link to the original repository: `https://github.com/qtremors/acqua`
...
- **Transfer of Rights**: You grant [Tremors](https://github.com/qtremors) the unlimited right to use, modify, distribute, and license your contribution as part of the project multiple times. *(This ensures the project owner can maintain legal control over the entire codebase and relicense it if necessary.)*
